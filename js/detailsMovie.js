...
const Castfun = (castee) => {
    let url = "./detailsMovie?id=" + encodeURIComponent(castee.id);
...
const Trailerfunc = function (id) {
    return `<iframe class="youtubePlayer" src="https://autoembed.to/movie/imdb/${id}" width="100%" height="100%" loading="lazy" frameborder="0" allowfullscreen></iframe>`;
};
...
const html2 = function (moviee) {
    ...
    <div class="movie_details_about">
        ...
        <div class="date_rating">
            <p class="time">${moviee.runtime
        } minutes</p><span class="dot dot2"></span>
            <p class="date">${moviee.release_date
        }</p><span class="dot dot2"></span>
        ...
        <div class="playButtonContainer"> 
            <span > <a class="GoogleButton" href="https://www.google.com/search?q=${moviee.title +
        " " +
        "(" +
        dateFormatter(moviee.release_date) +
        ")"
...
const recommMovieFun = (mov) => {
    let url = "./detailsMovie.html?id=" + encodeURIComponent(mov.id);
